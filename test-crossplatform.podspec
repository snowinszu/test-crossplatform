#
#  Be sure to run `pod spec lint test-crossplatform.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "test-crossplatform"
  spec.version      = "0.0.1"
  spec.summary          = 'CDNBye iOS SDK for Cross-platform P2P Streaming.'
  ...
  spec.source       = { :git => 'https://github.com/cdnbye/ios-p2p-engine.git', :tag => spec.version.to_s }
